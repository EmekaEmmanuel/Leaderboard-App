...
This project is a simple program to track our scores; It allows to input scores using the leaderboard API. Built using webpack and served by a webpack dev server.
